                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            <label for="example-input2-group1" class="example-input2-group1">Budget</label>
...
// proses perhitungan
    function calculate() {
        ...
        //_____________________________________________________________________________________________
        //13. new_monthly_bill
        //Rumus: IF(Electrical power="R1 - 900 VA", Monthly electricity imported from PLN grid*electrical power harga = R1 900, Monthly electricity imported from PLN grid*electrical power harga = R1 1300)
        //Satuan:IDR
             if (electrical_power == <?php echo json_encode($electrical_power_value['tegangan']); ?>) {
