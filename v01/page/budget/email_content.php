    ...
    <div style="text-align: justify">
        ...
        <table align='center' border='0'>
            <tr>
                ...
                <td style='border-bottom:2px solid #03239C;'><img width='40' src='https://kalkulator.solarhub.id/assets/img/icon/2.png'></td>
                <td width='800' style='color: #03239C; border-bottom:2px solid #03239C;''>BUDGET</td>
            </tr>
