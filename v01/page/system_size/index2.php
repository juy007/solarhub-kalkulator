...
<div class="container-fluid"> 
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <h4 style="background-color: #275798;" class="mt-0 header-title btn btn-warning btn-square btn-skew waves-effect waves-light"><span><?php echo $lang['your_solar_calculator']; ?></span></h4>
                    <p class="text-muted mb-4"></p> 
                     
                    <hr>
                    <form>
                        <div class="form-group">
                            <label for="example-input2-group1" class="example-input2-group1">System Size</label>
            ...
            <div class="card" id="export_button">
                <div class="card-body">
                 <h4 style="background-color: #275798;" class="mt-0 header-title btn btn-warning btn-square btn-skew waves-effect waves-light"><span><?php echo $lang['export']; ?></span></h4>
                        <!--Form export PDF-->
    ...
    <div class="col-lg-8">
            ...
            <div class="card-body">
                ...
                <!--    <table border="1">
                    ...
                    <div class="tab-pane fade show active" id="profile-dash">
                        <h4 style="background-color: #275798;" class="header-title mt-0 btn btn-warning btn-square btn-skew waves-effect waves-light"><?php echo $lang['key_result']; ?></h4>        
                        <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content" id="profile-tabContent">
                    <div class="tab-pane fade show active" id="profile-dash">
                        <h4 style="background-color: #275798;" class="header-title mt-0 btn btn-warning btn-square btn-skew waves-effect waves-light"><?php echo strtoupper($lang['your_solar_potential_in_details']); ?></h4> 
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card">
                        ...
                        <div class="col-lg-8 mb-3 mb-lg-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 align-item-center" style="text-align: center;">
                                    <canvas id="system-size"></canvas> 
                                    <canvas id="system-size_view"></canvas>
                                    <br>
                                    <span style="background-color: #275799;padding: 8px;color: #fff;"><?php echo strtoupper($lang['year']); ?></span>
                                </div>
                            </div> 
                        </div><!--end col-->
                        <div class="col-lg-2 mb-3 mb-lg-0">
...
<script type="text/javascript">
    ...
    function aktiv(){
        $("#system-size").hide();
        $("#system-size_view").show();
        $("#best-performance").hide();
...
// proses perhitungan
    function calculate() {
        ...
        if ($("#system_size").val() == '' || $("#system_size").val() == '0') {
            ...
            $("#system-size").show();
            $("#system-size_view").hide();
            if (<?php echo json_encode($_SESSION['status_recommended']); ?> == 'true') {
        ...
        //Satuan :kWp
            ...
            if (system_size>= type_a) {
                adjusted_system_size_1= type_a.toFixed(1);
            }else{
                adjusted_system_size_1= system_size.toFixed(1);
            }
        ...
        //___________________________________________________________________________________________
        //10.monthly_electricity_imported_from_pln_grid
        ...
        //11. new_monthly_bill
        //Rumus: IF(electrical power="R1 - 900 VA", Monthly electricity imported from PLN grid*harga elctrical power =r1 900, Monthly electricity imported from PLN grid*harga elctrical power =r1 1300)
        //Satuan : IDR
             if (electrical_power == <?php echo json_encode($electrical_power_value['tegangan']); ?>) {
                var new_monthly_bill_result = monthly_electricity_imported_from_pln_grid*<?php echo json_encode($electrical_power_value['harga']); ?>;
                ...
                var new_monthly_bill_result = monthly_electricity_imported_from_pln_grid*<?php echo json_encode($electrical_power_value2['harga']); ?>;
                new_monthly_bill = Math.round(new_monthly_bill_result);
                function rubah(angka){
                    var reverse = angka.toString().split('').reverse().join(''),
                    ribuan = reverse.match(/\d{1,3}/g);
        ...
        //System Cost
            ...
            !function($) {
                ...
                ChartJs.prototype.init = function() {
                    ...
                    this.respChart($("#system-size"),'Line',lineChart, lineOpts);
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#expmap').click(function(){
            ...
            var win = window.open(<?php echo json_encode($_SESSION['link_province']); ?>,'_blank');
            win.focus();
        });
    });
</script>
...
//Menampilkan Grafik 0_____________________________________________________________________
      !function($) {
            ...
            ChartJs.prototype.init = function() {
                ...
                this.respChart($("#system-size_view"),'Line',lineChart, lineOpts);
