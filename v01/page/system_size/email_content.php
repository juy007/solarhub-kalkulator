...
<body>
    ...
    <div style="text-align: justify">
        <?php echo "<div style='margin-left: 35px; width: 80%;'>
        <br><br>
        <table align='center' border='0'>
            <tr>
                ...
                <td style='border-bottom:2px solid #03239C;''><img width='40' src='https://kalkulator.solarhub.id/assets/img/icon/1.png'></td>
