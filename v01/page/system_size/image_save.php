...
$page_title = "System Size | ". $lang['export_image'];
...
?>
    <div class="container-fluid" >
                <div class="row" >
                    <div class="col-md-12">
                        <a href="../system_size" class="btn btn-dark"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
                        <a href="Solarhub_Size_System.png" download="Solarhub_Size_system" class="btn btn-dark"><i class="fas fa-download"></i> Download</a>
                        <div class="card">
                            <?php
                                ...
                                //Save the image
                                file_put_contents('Solarhub_Size_System.png', $unencodedData);
                            ?>
