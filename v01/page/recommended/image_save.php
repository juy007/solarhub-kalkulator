...
?>
    <div class="container-fluid" >
                <div class="row" >
                    <div class="col-md-12">
                        <a href="../recommended" class="btn btn-dark"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
                        <a href="<?php echo "Solarhub_Best_Performance_".ucwords($_SESSION['calculator_type']).".png" ?>" download="<?php echo "Solarhub_Best_Performance_".ucwords($_SESSION['calculator_type']).".png" ?>" class="btn btn-dark"><i class="fas fa-download"></i> Download</a>
                        <div class="card">
                            <?php
