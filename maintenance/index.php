...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Solarlab Indonesia | <?php echo ucwords(strtolower($lang['calculator'])); ?></title>
                ...
                <div class="container-fluid"> 
                    <div class="row">
                        ...
                        <div class="col-lg-6" style="background-color:rgba(0, 0, 0, 0.6);"><br>
                           ...
                           <p style="text-align: center;color: #fff;font-weight: bold;font-size: 30px;margin-top: 180px;margin-bottom: 180px;">Maintenance.</p>
