...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Solarhub Indonesia | 404</title>
    ...
    <body>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="col-lg-6" style="background-color:rgba(0, 0, 0, 0.6);"><br>
                            <div class="row col-lg-11 text-center" style="margin-right: auto;margin-left: auto;">
                                <div class="col-md-6" style="background-color: #fff; padding-top: 3px;">
                                    <a href="../../"><img width="180" src="../../assets/img/solarlab-logo2.png"></a>
                                </div><!--end col-->
                                <div class="col-md-6" style="background-color: #275798; padding-top: 3px;">
                                    <h3 style="color: #FFF;font-weight: bold;font-size: 18px;"><i class="mdi mdi-calculator"></i>CALCULATOR</h3>
                                </div>
                            </div>
                           <p style="text-align: center;color: #fff;font-weight: bold;font-size: 30px;margin-top: 180px;margin-bottom: 180px;"><i class="mdi mdi-sim-off"></i>404<br>Page Not Found.</p>
            ...
            <!--    <footer class="footer text-center text-sm-left" style="color:#fff;">
                Copyright &copy; <?php echo date('Y'); ?> Solar Lab Indonesia
                </footer>-->
            </div>
            <!-- end page content -->
        </div>
