...
$date= date('d/m/Y');
mysqli_query($conn,"INSERT INTO export_amount VALUES('','$_SESSION[calculator_type]','pdf','','$date')");
...
$form_page_export = $_POST['form_page_export'];

$system_cost_export = $_POST['system_cost_export'];
	...
	<div style="margin-left: 35px; width: 80%;">
		...
		<table align="center" border="0">
			<tr>
				...
				<td style="border-bottom:2px solid #03239C;"><img width="40" src="../../assets/img/icon/<?php echo $iconbut; ?>.png"></td>
				<td width="800" style="color: #03239C; border-bottom:2px solid #03239C;padding-top: 14px;">Best Performance | <?php echo ucwords(str_replace("_"," ", $_SESSION['calculator_type'])); ?></td>
			</tr>
		</table><br><br><br>
		<table align="center" border="0">
			<tr>
				...
				<td valign="top">
					<table>
						...
						<tr>
							...
							<td>:</td>
							<td><span id="from_page_export"><?php echo $form_page_export; ?></span></td>
							<td>kWp</td>
						</tr>
					</table>
				</td>
				...
				<td>
					<table>
						...
						<tr>
							...
							<td>:</td>
							<td><span id="system_cost_export"><?php echo $system_cost_export; ?></span></td>
							<td>IDR</td>
						</tr>
						...
						<tr>
							...
							<td>:</td>
							<td><span id="monthly_savings_ip"><?php echo $monthly_savings_ip_export; ?></span></td>
							<td>%</td>
						</tr>
						<tr>
...
<?php 
	...
	$pdf->WriteHTML($html);
	$pdf->Output('Solarhub_Best_Performance_'.ucwords(str_replace("_"," ", $_SESSION['calculator_type'])).'.pdf', 'D');
?>