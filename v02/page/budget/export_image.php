...
$date= date('d/m/Y');
mysqli_query($conn,"INSERT INTO export_amount VALUES('','budget','image','','$date')");
	...
	<div style="margin-left: 35px; width: 80%;" id="screenshoot">
		...
		<table align="center" border="0">
			<tr>
				...
				<td style="border-bottom:2px solid #03239C;"><img width="40" src="../../assets/img/icon/2.png"></td>
				<td width="800" style="color: #03239C; border-bottom:2px solid #03239C;"><?php echo $lang['budget']; ?></td>
			</tr>
		</table><br><br><br>
		<table align="center" border="0">
			<tr>
