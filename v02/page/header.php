                            ...
                            <ul class="navigation-menu list-unstyled" style="background-color: #275798;">
                                <li class="submenu">
                                    <a style="color: #fff; font-size: 18px;" href="../../">
                                        <img style="height: 40px;margin-left: auto;margin-right: auto;margin-top: -12px;" src="../../assets/img/icon/dashboard_ina.png">
                                    </a>
                                </li>
                                <li class="submenu">
                                    <a style="color: #fff; font-size: 18px;" href="../system_size">
                                ...
                                <li class="submenu">
                                    <a style="color: #fff; font-size: 18px;" href="../budget">
                                ...
                                <li class="submenu">
                                    <a style="color: #fff; font-size: 18px;" href="../expected_saving">
