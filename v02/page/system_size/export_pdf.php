	...
	<div style="margin-left: 35px; width: 80%;">
		...
		<table align="center" border="0">
			<tr>
				...
				<td style="border-bottom:2px solid #03239C;"><img width="40" src="../../assets/img/icon/1.png"></td>
				<td width="800" style="color: #03239C; border-bottom:2px solid #03239C;padding-top: 14px;"><?php echo $lang['system_size']; ?></td>
			</tr>
		</table><br><br><br>
		<table align="center" border="0">
			<tr>
...
<?php 
	...
	$pdf->WriteHTML($html);
	$pdf->Output('Solarhub '.$lang['system_size'].'.pdf', 'D');
?>