	...
	<div style="margin-left: 35px; width: 80%;">
		...
		<table align="center" border="0">
			<tr>
				...
				<td width="800" style="color: #03239C; border-bottom:2px solid #03239C;padding-top: 14px;"><?php echo $lang['expected_saving']; ?></td>
			</tr>
		</table><br><br><br>
		<table align="center" border="0">
			<tr>
...
<?php 
	...
	$pdf->WriteHTML($html);
	$pdf->Output('Solarhub '.$lang['expected_saving'].'.pdf', 'D');
?>