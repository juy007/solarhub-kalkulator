       ...
       // var new_monthly_bill;
        ...
        function rubah(angka){
            ...
            if (electrical_power == <?php echo json_encode($electrical_power_value['tegangan']); ?> && monthly_bill>=(type/1000*<?php echo json_encode($electrical_power_value['harga']); ?>*40)) {
                ...
                var monthly_bill_result = '';
                monthly_bill = Math.round(monthly_bill_result);
                document.getElementById("new_monthly_bill_c").innerHTML = rubah(monthly_bill);
                document.getElementById("new_monthly_bill_export").value = rubah(monthly_bill);

            }
            //document.getElementById("new_monthly_bill_test").innerHTML = rubah(new_monthly_bill);
        //______________________________________________________________________________________
        //18.monthly_savings
        ...
        //satuan:IDR
            ...
            //document.getElementById("monthly_savings_test").innerHTML = rubah(monthly_savings);
        //______________________________________________________________________________________
        ...
        //bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
           ...
           if ((bill_without_pv11 - savings11) > (capacity/1000*(pln_electricity_tariff*(Math.pow((1+electricity_tariff_increase),(11-1))))*40*12)){
            ...
            var chartLine = new ApexCharts(document.querySelector('#savings_grafik'), optionsLine);
