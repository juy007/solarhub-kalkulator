                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <p style="font-size: 17px;color: #000;"><?php echo $lang['notif_avg_bill']; ?></p><hr>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            ...
                                                            <button style="float: right;" type="button" class="btn btn-dark" onclick="falseRecommended()"> <i class="mdi mdi-close-circle"></i> <!--Decline--><?php echo $lang['decline_recommended']; ?></button>
                                                            <button style="float: right; margin-right: 3px;" type="button" class="btn btn-secondary" onclick="trueRecommended()"><i class="mdi mdi-check-circle"></i> <!--Accept--><?php echo $lang['accept_recommended']; ?></button>
...
<script type="text/javascript">  
//menampilkan modal verifikasi rekomendasi
...
<script type="text/javascript">  
//tidak setuju menggunakan rekomedasi
    function falseRecommended() {
...
<script type="text/javascript">  
//setuju menggunakan rekomedasi
    function trueRecommended() {
        $('#modal_recommended').modal('hide');
    ...
    $(document).ready(function(){
        $('#btnContinue').click(function(){
            ...
            document.getElementById("notif").innerHTML = <?php echo json_encode($lang['notification_validation_form']); ?>;
                ...
                var rekening_minimum = $("#type").val()/1000*1467.2*40;
                if ($("#avgbill").val().replace(/\./g, "") < rekening_minimum) {
                    ...
                    }else if (document.getElementById("recommended").checked == false) {
                        document.getElementById("status_recommended").value = 'false';
                        document.getElementById("notif").innerHTML = "";
                        document.getElementById("form-calculator").submit();
                    }
