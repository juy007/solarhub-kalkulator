...
$date= date('d/m/Y');
mysqli_query($conn,"INSERT INTO export_amount VALUES('','recommended','image','','$date')");
	...
	<div style="margin-left: 35px; width: 80%;" id="screenshoot">
		...
		<table align="center" border="0">
			<tr>
				...
				<td width="800" style="color: #03239C; border-bottom:2px solid #03239C;"><?php echo $lang['recommended2']; ?></td>
			</tr>
		</table>
		<br>
		<table align="center" border="0">
