...
$icon_menu = "<img src='../../assets/img/icon/4.png' alt='user' class='img-zoom rounded-circle img-thumbnail mb-4'>";// "<i class='mdi mdi-cards-playing-outline' style='font-size:50px; width:150px;'></i>";
include '../header.php';
?>
    ...
    function calculate() {
        ...
        //Satuan :kWh
            var  estimated_system_size_result = monthly_required_solar_yield/30/(1- <?php echo json_encode( $system_losses_persen); ?>)/data_irradiance;
             estimated_system_size = estimated_system_size_result;
        //______________________________________________________________________________________
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#expmap').click(function(){
            ...
            var win = window.open(<?php echo json_encode("https://dummy.solarhub.id/kalkulator/robot/recommended"); ?>+<?php echo json_encode("/".$_SESSION['name_province'].'/'); ?>,'_blank');
            win.focus();
        });
    });
</script>
