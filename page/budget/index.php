...
$page_title = $lang['budget'];
$icon_menu = "<img src='../../assets/img/icon/2.png' alt='user' class='img-zoom rounded-circle img-thumbnail mb-4'>";// "<i class='mdi mdi-cards-playing-outline' style='font-size:50px; width:150px;'></i>";
include '../header.php';
?>
                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            <label for="example-input2-group1" class="example-input2-group1"><?php echo $lang['budget']; ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="budget" id="budget" onkeypress="return hanyaAngka(event)">
                                <div class="input-group-append">
                                    <span class="input-group-text isiformrange" style="font-size: 10px;">IDR</span>
                                <!--     <button type="button" class="input-group-text" id="iconform" data-container="body" data-toggle="popover" data-placement="right" data-content="<?php echo $lang['float_budget']; ?>"><i id="texticonform">?</i></button>-->
                                </div>
                            </div>  
                        </div>
                        <div style="font-size: 10px;text-align: justify;" class="alert alert-light border-0 mb-0" role="alert">
                            <?php echo $lang['float_budget']; ?>
                        </div>
                ...
                <div class="card-body">
                 <h4 style="background-color: #275798; color: #fff;" class="mt-0 header-title btn btn-skew"><span><?php echo $lang['export']; ?></span></h4>
                    ...
                    <form method="POST" action="" id="form_export">
                        ...
                        <input type="hidden" name="budget_export" id="budget_export">
                 ...
                 <div class="button-items" style="">
                    <?php 
                        $export_pdf_q=mysqli_query($conn,"SELECT COUNT(*) AS count_pdf FROM export_amount WHERE calculator_type='budget' AND export_type='pdf'");
                        $export_pdf_v=mysqli_fetch_array($export_pdf_q);
                        $export_image_q=mysqli_query($conn,"SELECT COUNT(*) AS count_image FROM export_amount WHERE calculator_type='budget' AND export_type='image'");
                        $export_image_v=mysqli_fetch_array($export_image_q);
                        $export_email_q=mysqli_query($conn,"SELECT COUNT(*) AS count_email FROM export_amount WHERE calculator_type='budget' AND export_type='email'");
                        $export_email_v=mysqli_fetch_array($export_email_q);
                        $export_map_q=mysqli_query($conn,"SELECT COUNT(*) AS count_map FROM export_amount WHERE calculator_type='budget' AND export_type='map'");
        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content" id="profile-tabContent">
                 ...
                 <h5 style="color: #275798;text-align:justify"><?php echo $lang['disclaimer1']; ?> <button data-toggle="modal" data-target="#myDisclaimer" id="" type="button" class="btn-dark btn-xs"> <?php echo $lang['btn_more']; ?></button></h5><hr>

                   <!-- The Modal -->
                    <div class="modal fade" id="myDisclaimer">
                        <div class="modal-dialog modal-lg">
                          ...
                          <!-- Modal body -->
                          <div class="modal-body">
                            <p style="text-align: justify;color: #275798;"><?php echo $lang['disclaimer2']; ?></p>
                          </div>
                                                ...
                                                <div class="carousel-item active">
                                                    <div class="text-center">
                                                        <div class="align-item-center">
                                                            ...
                                                            <a class="btn btn-sm btn-dark text-light mb-2"><?php echo $lang['kg_co2']; ?></a><hr>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <table id="footable-1" class="table" data-sorting="true">
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td style="font-size: 12px;"><?php echo $lang['kg_co2']; ?></td>
                                            </tr>
                                             <tr>
...
<script type="text/javascript">
    ...
    function aktiv(){
        ...
        document.getElementById("budget").value = <?php echo json_encode($_SESSION['form_page']); ?>;
...
// proses perhitungan
    function calculate() {
        ...
        var budget = Number($("#budget").val().replace(/\./g, ""));//menghilangkan titik
        document.getElementById("budget_export").value = $("#budget").val();
        ...
        //1.estimated_system_size
        //Rumus : budget/system price harga from poly
        //Satuan:kWp
            var estimated_system_size_result = budget/<?php echo json_encode($system_price_value['harga']); ?>;
            estimated_system_size = Number(estimated_system_size_result);
        //_____________________________________________________________________________________________ 
        //2.adjusted_system_size_1
        //Rumus: IF(estimated system_size>=(type/1000*1.2), (type/1000*1.2), estimted systen size)
        //Satuan:kWp
            var type_a=type/1000*1.2;
            if (estimated_system_size >= type_a) {
                var adjusted_system_size_1_result =  type_a;
                adjusted_system_size_1 = Number(adjusted_system_size_1_result);
            }else{
                adjusted_system_size_1 = Number(estimated_system_size);
            }
        //_____________________________________________________________________________________________
        //3.total_solar_module
        //Rumus: ROUNDDOWN(adjusted system size*1000/modul type,0)
        //Satuan:pcs
        ...
        //_____________________________________________________________________________________________
        //4.new_system_size
        //Rumus:modul type*total solar modul/1000
        //Satuan:kWp
            var new_system_size_result = module_type*total_solar_module/1000;
            var new_system_size_view = new_system_size_result.toFixed(1);
            new_system_size =  Number(new_system_size_result);
            document.getElementById("new_system_size_b").innerHTML = new_system_size_view.replace(/\./g, ",");
            document.getElementById("new_system_size_c").innerHTML = new_system_size_view.replace(/\./g, ",");
            document.getElementById("new_system_size_export").value = new_system_size_view.replace(/\./g, ",");
        //_____________________________________________________________________________________________
        //5.new_system_cost
        //Rumus: new system size* system price harga from poly
        //Satuan: IDR
            var new_system_cost_result = new_system_size*<?php echo json_encode($system_price_value['harga']); ?>;
            var new_system_cost_view = Math.round(new_system_cost_result);
            new_system_cost = new_system_cost_result;

            document.getElementById("new_system_cost_a").innerHTML = rubah(new_system_cost_view);
            document.getElementById("new_system_cost_c").innerHTML = rubah(new_system_cost_view);
            document.getElementById("new_system_cost_export").value = rubah(new_system_cost_view);

        //_____________________________________________________________________________________________
        //6. roof_space
        //Rumus: IF(modul type=350, new system size*1000/modul power density for mono, new system size*1000/modul power density for poli)
        //Satuan: m<sup>2</sup>
            if (module_type == 350) {
                var roof_space_result =  new_system_size*1000/<?php echo json_encode($solar_module_capacity_value2['modul_power_density']); ?>;
                var roof_space_view = Math.round(roof_space_result);
                roof_space = roof_space_result;
                document.getElementById("roof_space_b").innerHTML = roof_space_view;
                document.getElementById("roof_space_c").innerHTML = roof_space_view;
                document.getElementById("roof_space_export").value = roof_space_view;
            }else{
        ...
        //_____________________________________________________________________________________________
        //7.monthly_electricity_use
        //Rumus: IF(Electrical power="R1 - 900 VA", Avg. bill/electrical power harga = R1 900, Avg. bill/electrical power harga = R1 1300)
        //Satuan:kWh
            if (electrical_power == <?php echo json_encode($electrical_power_value['tegangan']); ?>) {
                ...
                var monthly_electricity_use_view = Math.round(monthly_electricity_use_result);
                monthly_electricity_use = monthly_electricity_use_result;
                document.getElementById("monthly_electricity_use_c").innerHTML = monthly_electricity_use_view;
                document.getElementById("monthly_electricity_use_export").value = monthly_electricity_use_view;
            }else{
        ...
        //_____________________________________________________________________________________________
        //8.monthly_solar_energy_production
        ...
        //Satuan:kWh
            ...
            var monthly_solar_energy_production_view = Math.round(monthly_solar_energy_production_result);
            monthly_solar_energy_production = monthly_solar_energy_production_result;
            document.getElementById("monthly_solar_energy_production_b").innerHTML = monthly_solar_energy_production_view;
            document.getElementById("monthly_solar_energy_production_c").innerHTML = monthly_solar_energy_production_view;
            document.getElementById("monthly_solar_energy_production_export").value = monthly_solar_energy_production_view;
        //_____________________________________________________________________________________________
        //9. monthly_solar_energy_use
        //Rumus: Monthly solar energy production*0.71
        //Satuan:kWh
            var monthly_solar_energy_use_result = monthly_solar_energy_production*0.71;
            var monthly_solar_energy_use_view = Math.round(monthly_solar_energy_use_result);
            monthly_solar_energy_use = monthly_solar_energy_use_result;
            document.getElementById("monthly_solar_energy_use_c").innerHTML = monthly_solar_energy_use_view;
            document.getElementById("monthly_solar_energy_use_export").value = monthly_solar_energy_use_view;
        //_____________________________________________________________________________________________
        //10. monthly_electricity_could_be_exported
        ...
        //Satuan:kWh
            ...
            monthly_electricity_could_be_exported = monthly_electricity_could_be_exported_result;
        //_____________________________________________________________________________________________
        //11. monthly_electricity_fed_back_into_pln_grid
        ...
        //Satuan:kWh
            ...
            var monthly_electricity_fed_back_into_pln_grid_view = Math.round(monthly_electricity_fed_back_into_pln_grid_result);
            monthly_electricity_fed_back_into_pln_grid = monthly_electricity_fed_back_into_pln_grid_result;
            document.getElementById("monthly_electricity_fed_back_into_pln_grid_c").innerHTML = monthly_electricity_fed_back_into_pln_grid_view;
            document.getElementById("monthly_electricity_fed_back_into_pln_grid_export").value = monthly_electricity_fed_back_into_pln_grid_view;
        //_____________________________________________________________________________________________
        //12.monthly_electricity_imported_from_pln_grid
        ...
        //Satuan:kWh
            ...
            var monthly_electricity_imported_from_pln_grid_view = Math.round(monthly_electricity_imported_from_pln_grid_result);
            monthly_electricity_imported_from_pln_grid = monthly_electricity_imported_from_pln_grid_result;
            document.getElementById("monthly_electricity_imported_from_pln_grid_c").innerHTML = monthly_electricity_imported_from_pln_grid_view;
            document.getElementById("monthly_electricity_imported_from_pln_grid_export").value = monthly_electricity_imported_from_pln_grid_view;
        //_____________________________________________________________________________________________
        //13. monthly_bill
        //Rumus:       if (electrical power="R1 - 900 VA" && Monthly electricity imported from PLN grid>0) {Monthly electricity imported from PLN grid*harga electrical power 900 VA;}elseif (electrical power="R1 - 900 VA" && Monthly electricity imported from PLN grid=0) {harga electrical power 900 VA*type/1000*40}elseif (electrical power<>"R1 - 900 VA" && Monthly electricity imported from PLN grid>0) {Monthly electricity imported from PLN grid*harga electrica; power 1300 VA }elseif (electrical power<>"R1 - 900 VA" && Monthly electricity imported from PLN grid=0) {harga electrica; power 1300 VA*type/1000*40}else{""}
        //Satuan:IDR

            if (electrical_power == <?php echo json_encode($electrical_power_value['tegangan']); ?> && monthly_electricity_imported_from_pln_grid>0) {
                var monthly_bill_result = monthly_bill;
                monthly_bill = monthly_bill_result;   
        ...
        //_____________________________________________________________________________________________
        //13. new_monthly_bill
        //Rumus: if (electrical power="R1 - 900 VA" && monthly bill>=(type/1000*harga eletrical power 900 va*40)) {monthly bill;}else if (electrical power="R1 - 900 VA" && monthly bill<=(type/1000*harga eletrical power 900 va*40)) {(type/1000*harga eletrical power 900 va*40);}else if (electrical power<>"R1 - 900 VA" && monthly bill>=(type/1000*harga electrical power 1300*40)) {monthly bill;}else if (AND(electrical power<>"R1 - 900 VA"; monthly bill<=(type/1000*harga electrical power 1300*40)) {(type/1000*harga electrical power 1300*40);}else{""}
        //Satuan:IDR
            ...
            if (electrical_power == <?php echo json_encode($electrical_power_value['tegangan']); ?> && monthly_bill>=(type/1000*<?php echo json_encode($electrical_power_value['harga']); ?>*40)) {
                ...
                var new_monthly_bill_view = Math.round(new_monthly_bill_result);
                new_monthly_bill = new_monthly_bill_result;
                document.getElementById("new_monthly_bill_c").innerHTML = rubah(new_monthly_bill_view);
                document.getElementById("new_monthly_bill_export").value = rubah(new_monthly_bill_view);
        ...
        //_____________________________________________________________________________________________
        //14.monthly_savings
        //Rumus: Avg. bill (monthly)-New monthly bill
        //Satuan:IDR
            var monthly_savings_result = avgbill - new_monthly_bill;
            var monthly_savings_view = Math.round(monthly_savings_result);
            monthly_savings = monthly_savings_result;
            document.getElementById("monthly_savings_c").innerHTML = rubah(monthly_savings_view);
            document.getElementById("monthly_savings_export").value = rubah(monthly_savings_view);
        //_____________________________________________________________________________________________
         //15.monthly_savings_ip
         //Rumus:Monthly savings/Avg. bill (monthly)
         //Satuan:%
            var monthly_savings_ip_result= monthly_savings / avgbill;
            var monthly_savings_ip_view = Math.round(monthly_savings_ip_result*100);
            monthly_savings_ip = monthly_savings_ip_result*100;
            document.getElementById("monthly_savings_ip_a").innerHTML = monthly_savings_ip_view;
            document.getElementById("monthly_savings_ip_c").innerHTML = monthly_savings_ip_view;
            document.getElementById("monthly_savings_ip_export").value = monthly_savings_ip_view;
        //_____________________________________________________________________________________________
        //16. payback_period
        //Rumus: New system cost/(Monthly savings*12)
        //Satuan:year
            var payback_period_result = new_system_cost/(monthly_savings * 12);
            var payback_period_view = Math.round(payback_period_result);
            payback_period = payback_period_result;
            document.getElementById("payback_period_a").innerHTML = payback_period_view;
            document.getElementById("payback_period_c").innerHTML = payback_period_view;
            document.getElementById("payback_period_export").value = payback_period_view;
        //_____________________________________________________________________________________________
        //17. emission_saved
        ...
        //Satuan:kg CO2
            ...
            var emission_saved_view = Math.round(emission_saved_result);
            emission_saved = emission_saved_result;
            document.getElementById("emission_saved_a").innerHTML = emission_saved_view;
            document.getElementById("emission_saved_c").innerHTML = emission_saved_view;
            document.getElementById("emission_saved_export").value = emission_saved_view;
        //_____________________________________________________________________________________________
        //18. planting
        //Rumus: Emission saved*0.05
        //Satuan:trees
            var planting_result = emission_saved *12*6.25;
            var planting_view = Math.round(planting_result);
            planting = planting_result;
            document.getElementById("planting_a").innerHTML = planting_view;
            document.getElementById("planting_c").innerHTML = planting_view;
            document.getElementById("planting_export").value = planting_view;
        //_____________________________________________________________________________________________
        ...
        //System Cost
            ...
            var solar_pv_production = monthly_solar_energy_production_result/30;
                if (electrical_power == <?php echo json_encode($electrical_power_value['tegangan']); ?>) {
            ...
            var sumbuY = Math.ceil(sumbuYmax / 1000000)*1000000;

            var sumbuYmin = Math.min(bwop1,bwp1);
            var sumbuY2 = Math.floor(sumbuYmin / 1000000)*1000000;
            //+-----+-------------------------+----------------------+--------------------+------------------+
            //dihitung_________________________________________________________END
            //save calculate
             $.ajax({
                type: 'POST',
            ...
            //Menampilkan Grafik Yang dihitung____________________________________________________________
             var optionsLine = {
              chart: {
                height: 500,
                type: 'line',
              ...
              subtitle: {
                text: <?php echo json_encode(strtoupper($lang['electricity_bill_comparison'])); ?>,
                align: 'left',
                margin: 30,
                offsetY: 10,
                style: {
              ...
              xaxis: {
                title: {
                    text: <?php echo json_encode(strtoupper($lang['year'])); ?>,
                },
                style: {
                  color: '#fff',
                  fontSize: '15px',
              ...
              yaxis: {
                title: {
                    text: 'Tagihan Listrik Dalam Rupiah'
                },
                tickAmount: 10,
                labels: {
                  show: true,
            ...
            var chartLine = new ApexCharts(document.querySelector('#budget-grafik'), optionsLine);
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#reset').click(function(){
            ...
            document.getElementById("new_monthly_bill_c").innerHTML = '0';
            document.getElementById("monthly_savings_c").innerHTML = '0';
            document.getElementById("monthly_savings_ip_a").innerHTML = '0';
            document.getElementById("monthly_savings_ip_c").innerHTML = '0';
            document.getElementById("payback_period_a").innerHTML ='0';
            document.getElementById("payback_period_c").innerHTML ='0';
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#expmap').click(function(){
            ...
            var win = window.open(<?php echo json_encode("https://dummy.solarhub.id/kalkulator/robot/budget"); ?>+<?php echo json_encode("/".$_SESSION['name_province'].'/'); ?>+document.getElementById("budget").value,'_blank');
            win.focus();
        });
    });
</script>
