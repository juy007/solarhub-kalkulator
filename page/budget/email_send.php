...
$date= date('d/m/Y');
mysqli_query($conn,"INSERT INTO export_amount VALUES('','budget','email','$_POST[email]','$date')");
...
$subjek = $lang['budget']; // Ambil subjek dari inputan form
                ...
                <td valign='top'>
                    <table>
                        ...
                        <tr>
                            <td>".$lang['budget']."</td>
                            <td>:</td>
                            <td><span id='budget_export'>".$budget."</span></td>
                            <td>IDR</td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><span id='monthly_savings'>".$monthly_savings_ip."</span></td>
                            <td>%</td>
                        </tr>
                        <tr>
