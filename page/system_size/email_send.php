...
$date= date('d/m/Y');
mysqli_query($conn,"INSERT INTO export_amount VALUES('','system_size','email','$_POST[email]','$date')");
...
$subjek = $lang['system_size']; // Ambil subjek dari inputan form
            ...
            <tr>
                <td valign='top'>
                    <table>
                        ...
                        <tr>
                            <td>".$lang['system_size']."</td>
                            <td>:</td>
                            <td><span id='system_size_export'>".$system_size."</span></td>
                            <td>kWp</td>
                        </tr>
                    </table>
                </td>
