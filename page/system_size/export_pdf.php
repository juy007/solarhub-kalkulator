...
$date= date('d/m/Y');
mysqli_query($conn,"INSERT INTO export_amount VALUES('','system_size','pdf','','$date')");
...
$system_size_export = $_POST['system_size_export'];
	...
	<div style="margin-left: 45px; width: 80%;">
		...
		<table align="center" border="0">
			<tr>
				...
				<td width="800" style="color: #03239C; border-bottom:2px solid #03239C;padding-top: 5px;"><?php echo $lang['system_size']; ?></td>
			</tr>
		</table><br>
		<table align="center" border="0">
			<tr>
		...
		<table align="center" border="0">
			<tr>
				<td style="border-bottom:2px solid #03239C;">&nbsp;<b><i class=""></i> INPUT</b></td>
				<td rowspan="2" width="30" style="border-right: 2px solid #03239C;"></td>
				<td rowspan="2" width="30"></td>
				<td style="border-bottom:2px solid #03239C;">&nbsp;<b><i class=""></i> OUTPUT</b></td>
			</tr>
			<tr>
				<!-- input-->
				<td valign="top">
					<table>
						...
						<tr>
							<td><?php echo $lang['system_size']; ?></td>
							<td>:</td>
							<td><span id="system_size_export"><?php echo $system_size_export; ?></span></td>
							<td>kWp</td>
						</tr>
					</table>
				</td>
...
<?php 
    ...
    $html2pdf->output('Solarhub '.$lang['system_size'].'.pdf');
