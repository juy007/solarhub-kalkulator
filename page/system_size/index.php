...
$page_title = $lang['system_size'];
$icon_menu = "<img src='../../assets/img/icon/1.png' alt='user' class='img-zoom rounded-circle img-thumbnail mb-4'>";// "<i class='mdi mdi-cards-playing-outline' style='font-size:50px; width:150px;'></i>";
include '../header.php';
?>
                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            <label for="example-input2-group1" class="example-input2-group1"><?php echo $lang['system_size']; ?></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="font-size: 10px;"><i>0 kWp</i></span>
                                </div>
                                <input type="range" class="custom-range form-control" value="0" max="100" id="myRange">
                                <input type="hidden" name="system_size" id="system_size">
                                <div class="input-group-append">
                                    <span class="input-group-text" style="font-size: 10px;"><i>100 kWp</i></span>
                                    <span class="input-group-text isiformrange" style="font-size: 10px;"><i id="outputrange">0</i>&nbsp;kWp</span>
                                    <!-- <button type="button" class="input-group-text" id="iconform" data-container="body" data-toggle="popover" data-placement="right" data-content="<?php echo $lang['float_system_size']; ?>"><i id="texticonform">?</i></button>-->
                                </div>
                            </div>  
                        </div>
                        <div style="font-size: 10px;text-align: justify;" class="alert alert-light border-0 mb-0" role="alert">
                            <?php echo $lang['float_system_size']; ?>
                        </div>
                ...
                <div class="card-body">
                 <h4 style="background-color: #275798; color: #fff;" class="mt-0 header-title btn btn-skew"><span><?php echo $lang['export']; ?></span></h4>
                    ...
                    <form method="POST" action="" id="form_export">
                        ...
                        <input type="hidden" name="system_size_export" id="system_size_export">
                 ...
                 <div class="button-items" style="">
                    <?php 
                        $export_pdf_q=mysqli_query($conn,"SELECT COUNT(*) AS count_pdf FROM export_amount WHERE calculator_type='system_size' AND export_type='pdf'");
                        $export_pdf_v=mysqli_fetch_array($export_pdf_q);
                        $export_image_q=mysqli_query($conn,"SELECT COUNT(*) AS count_image FROM export_amount WHERE calculator_type='system_size' AND export_type='image'");
                        $export_image_v=mysqli_fetch_array($export_image_q);
                        $export_email_q=mysqli_query($conn,"SELECT COUNT(*) AS count_email FROM export_amount WHERE calculator_type='system_size' AND export_type='email'");
                        $export_email_v=mysqli_fetch_array($export_email_q);
                        $export_map_q=mysqli_query($conn,"SELECT COUNT(*) AS count_map FROM export_amount WHERE calculator_type='system_size' AND export_type='map'");
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content" id="profile-tabContent">
                    <div class="tab-pane fade show active" id="profile-dash">
                     <!--<h4 style="background-color: #275798;" class="header-title mt-0 btn btn-warning btn-square btn-skew waves-effect waves-light">ELECTRICITY BILL COMPARISON</h4>--> 
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card">
...
<script type="text/javascript">
    ...
    function aktiv(){
        ...
        document.getElementById("system_size").value = <?php echo json_encode($_SESSION['form_page']); ?>;
...
<script>
    ...
    var output2 = document.getElementById("system_size");
...
// proses perhitungan
    function calculate() {
        ...
        var system_size = Number($("#system_size").val());
        document.getElementById("system_size_export").value = system_size;
        ...
        if ($("#system_size").val() == '' || $("#system_size").val() == '0') {
        ...
        //1. adjusted_system_size_1
        //Rumus : IF(system size>=(type/1000*1.2), (type/1000*1.2), system size)
        //Satuan :kWp
            var type_a = type/1000*1.2;
            if (system_size>= type_a) {
                adjusted_system_size_1= type_a;
            }else{
                adjusted_system_size_1= system_size;
            }
        //______________________________________________________________________________________
        //2. solar_module
        //Rumus: ROUNDDOWN(adjusted system size 1*1000/modul type,0)
        //Satuan : pcs
            var solar_module_result = Number(adjusted_system_size_1)*1000/module_type;
            solar_module = Math.floor(solar_module_result);
        //______________________________________________________________________________________
        //3. new_system_size
        //Rumus: modul type*soalr module/1000
        //Satuan : kWp
        ...
        //Satuan : kWp
            if (module_type == 350) {
                ...
                var roof_space_view = Math.round(roof_space_result.toFixed(2));
        ...
        //5. system_cost
        //Rumus: new system size*system price fo poly
        //Satuan : IDR
            var system_cost_result = new_system_size*<?php echo json_encode($system_price_value['harga']); ?>;
            var system_cost_view = Math.round(system_cost_result); 
            system_cost = system_cost_result; 
            
            document.getElementById("system_cost_a").innerHTML = rubah(system_cost_view);
            document.getElementById("system_cost_c").innerHTML = rubah(system_cost_view);
            document.getElementById("system_cost_export").value = rubah(system_cost_view);
        //__________________________________________________________________________________________
        //6. monthly_electricity_use
        ...
        //7. monthly_solar_energy_production
        ...
        //__________________________________________________________________________________________
        //9. monthly_electricity_could_be_exported
        ...
        //__________________________________________________________________________________________
        //10. Monthly electricity fed back into PLN grid (65%)
        ...
        //___________________________________________________________________________________________
        //11.monthly_electricity_imported_from_pln_grid
        ...
        //11. new_monthly_bill
        /*Rumus: if (electrical power="R1 - 900 VA"; monthly bill>=(type/1000*harga electrical power 900 VA*40)) {
                monthly bill;
            }else if (electrical power="R1 - 900 VA"; monthly bill<=(type/1000*harga electrical power 900 VA*40)) {
                (type/1000*harga electrical power 900 VA*40)
            }else if (electrical power<>"R1 - 900 VA"; monthly bill>=(type/1000*harga electrical power 1300 VA*40)) {
                monthly bill
            }else if (electrical power<>"R1 - 900 VA"; monthly bill<=(type/1000*harga electrical power 1300 VA*40)) {
                (type/1000*harga electrical power 1300 VA*40)
            }else{
                ""
            }*/
        //Satuan : IDR
        ...
        //System Cost
           ...
           if ((bill_without_pv11 - savings11) > (capacity/1000*(pln_electricity_tariff*(Math.pow((1+electricity_tariff_increase),(11-1))))*40*12)){
            ...
            var chartLine = new ApexCharts(document.querySelector('#system-size'), optionsLine);
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#reset').click(function(){
            ...
            document.getElementById("system_cost_a").innerHTML = '0';
            document.getElementById("system_cost_c").innerHTML = '0';
            ...
            document.getElementById("system_size").value = 0;
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#expmap').click(function(){
            ...
            var win = window.open(<?php echo json_encode("https://dummy.solarhub.id/kalkulator/robot/system_size"); ?>+<?php echo json_encode("/".$_SESSION['name_province'].'/'); ?>+document.getElementById("system_size").value,'_blank');
            win.focus();
        });
    });
</script>
