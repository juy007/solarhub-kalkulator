...
$page_title = $lang['expected_saving'];
                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            <label for="example-input2-group1" class="example-input2-group1"><?php echo $lang['expected_saving']; ?></label>
                ...
                <div class="card-body">
                 <h4 style="background-color: #275798; color:#fff;" class="mt-0 header-title btn btn-skew"><span><?php echo $lang['export']; ?></span></h4>
                    ...
                    <form method="POST" action="" id="form_export">
                        ...
                        <input type="hidden" name="monthly_bill_export" id="new_monthly_bill_export">
                        ...
                        <div class="col-lg-8 mb-3 mb-lg-0">
                            <div class="row">
                                <div class="col-10 align-item-center" style="text-align: center;">
                                    <div class="">
                                        <div id="expected-savig-grafik"></div>
                                    </div>
                                </div>
                            </div> 
                        </div><!--end col-->
...
var savings = Number($("#expected_saving").val()/100);
        document.getElementById("expected_saving_export").value = $("#expected_saving").val();
       ...
       // var new_monthly_bill;
        ...
        //satuan: IDR
            ...
            estimated_monthly_saving = estimated_monthly_saving_result;
        ...
        //satuan:kWh
            ...
            monthly_energy_imported_from_pln = monthly_energy_imported_from_pln_result;
        ...
        //satuan:kWh
            ...
            monthly_required_solar_yield = monthly_required_solar_yield_result;
        ...
        //satuan:kWp
            ...
            if (estimated_system_size >= type_a ) {
                adjusted_system_size_1 = Number(type_a);
            }else{
        ...
        //satuan:kWp
            ...
            document.getElementById("new_system_size_b").innerHTML = new_system_size_view.replace(/\./g, ",").replace(/\./g, ",");
            ...
            // document.getElementById("new_system_size_test").innerHTML = new_system_size_view;
        ...
        //satuan:m<sup>2</sup>
            if (module_type == 350) {
                ...
                roof_space_view = Math.round(roof_space_result);
        ...
        //satuan:IDR
            ...
            new_system_cost_view = Math.round(new_system_cost_result); 
        ...
        //______________________________________________________________________________________
        //17. new_monthly_bill
        //Rumus: if (electrical power="R1 - 900 VA"&& monthly bill>=(type/1000*harga electrica power 900 VA*40)) {monthly bill;}else if (electrical power="R1 - 900 VA"&& monthly bill<=(type/1000*harga electrica power 900 VA*40)) {type/1000*harga electrica power 900 VA*40}else if (electrical power<>"R1 - 900 VA"&&monthly bill>=(type/1000*harga electrical power 1300 VA*40)) {monthly bill;}else if (electrical power<>"R1 - 900 VA"&& monthly bill<=(type/1000*harga electrical power 1300 VA*40)) {type/1000*harga electrical power 1300 VA*40}else{""}
        //satuan:IDR
        ...
        //satuan:%
            ...
            var new_monthly_savings_ip_view = Math.round(new_monthly_savings_ip_result*100);
            new_monthly_savings_ip = new_monthly_savings_ip_result*100;
            document.getElementById("new_monthly_savings_ip_a").innerHTML = new_monthly_savings_ip_view;
            document.getElementById("new_monthly_savings_ip_c").innerHTML = new_monthly_savings_ip_view;
            document.getElementById("new_monthly_savings_ip_export").value = new_monthly_savings_ip_view;
        //______________________________________________________________________________________
        //17. payback_period
        ...
        //______________________________________________________________________________________
           ...
           if ((bill_without_pv11 - savings11) > (capacity/1000*(pln_electricity_tariff*(Math.pow((1+electricity_tariff_increase),(11-1))))*40*12)){
            ...
            var chartLine = new ApexCharts(document.querySelector('#expected-savig-grafik'), optionsLine);
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#expmap').click(function(){
            ...
            var win = window.open(<?php echo json_encode("https://dummy.solarhub.id/kalkulator/robot/expected_saving"); ?>+<?php echo json_encode("/".$_SESSION['name_province'].'/'); ?>+document.getElementById("expected_saving").value,'_blank');
            win.focus();
        });
    });
</script>
