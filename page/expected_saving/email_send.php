...
$date= date('d/m/Y');
mysqli_query($conn,"INSERT INTO export_amount VALUES('','expected_saving','email','$_POST[email]','$date')");
...
$new_monthly_savings_ip = $_POST['new_monthly_savings_ip'];
...
$subjek = $lang['expected_saving']; ; // Ambil subjek dari inputan form
$pesan = "<table align='center' border='0'>
            ...
            <tr>
                ...
                <td valign='top'>
                    <table>
                        ...
                        <tr>
                            <td>Savings</td>
                            <td>:</td>
                            <td><span id='expected_saving_export'>".$expected_saving."</span></td><td>%</td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table>
                        <tr>
                            <td>".str_replace('<br>', ' ',$lang['new_system_size'])."</td>
                            <td>:</td>
                            <td><span id='new_system_size_export'>".$new_system_size."</span></td>
                            <td>kWp</td>
                        </tr>
                        <tr>
                            <td>".str_replace('<br>', ' ',$lang['roof_space'])."</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><span id='new_system_cost_export'>".$new_system_cost."</span></td>
                            <td>IDR</td>
                        </tr>
                        ...
                        <tr>
                            <td>".str_replace('<br>', ' ',$lang['monthly_solar_energy_production'])."</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td> <span id='monthly_bill_export'>".$monthly_bill."</span></td>
                            <td>IDR</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><span id='monthly_savings'>".$new_monthly_savings_ip."</span></td>
                            <td>%</td>
                        </tr>
                        <tr>
