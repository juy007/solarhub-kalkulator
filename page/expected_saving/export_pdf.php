	...
	<div style="margin-left: 35px; width: 80%;">
		...
		<table align="center" border="0">
			<tr>
				...
				<td width="800" style="color: #03239C; border-bottom:2px solid #03239C;padding-top: 5px;"><?php echo $lang['expected_saving']; ?></td>
			</tr>
		</table><br>
		<table align="center" border="0">
			<tr>
...
<?php 
    ...
    $html2pdf->output('Solarhub '.$lang['expected_saving'].'.pdf');
