...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            #iconform{
                background-color: #275798;border-radius: 100%;height: 24px;width: 24px;margin-top:auto;margin-bottom: auto;margin-left: 2px;float: right;
            }
             #iconform2{
                background-color: #275798;border-radius: 100%;height: 22px;width: 20px; margin-top:auto;margin-bottom: auto;margin-left: 0px;float: left;
            }
            #texticonform{
                font-size: 13px;font-weight: bold;text-align: center;color: #FFF;margin-left: -5px;margin-top: -1px;

            }
            #texticonform2{
                font-size: 12px;font-weight: bold;text-align: center;color: #FFF;margin-left: -5px;margin-top:-1px;

            }
            .isiformrange{
                font-size: 13px;background-color: #275798;color: #FFF;
            }
            ...
            @media (min-width: 1200px) {
                .btn-back {
                    margin-top: -25px; margin-left: -100px;margin-right: 20px;
                }
            }
        </style>
                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <div class="media-body">
                                <h3 class="text-light"><!--<a href="../../" type="button" class="btn btn-outline-warning btn-back"> <i style="font-size: 23px;" class="mdi mdi-backburger"> </i> <br><?php echo ucwords($lang['back']); ?></i> </a>--><span class="online-icon"><i class="mdi mdi-record text-success"></i> <?php echo $icon_menu; ?> <?php echo $page_title; ?></span> </h3> 
                            </div>                                  
                            ...
                            <ul class="navigation-menu list-unstyled" style="background-color: #275798;">
                                <li class="submenu">
                                    <a class="btnMenu" href="../../">
                                        <img style="height: 40px;margin-left: auto;margin-right: auto;margin-top: -12px;" src="../../assets/img/icon/dashboard_ina1.png">
                                    </a>
                                </li>
                                <li class="submenu">
                                    <a style="color: #fff;" class="btnMenu" href="../system_size">
                                        ...
                                        <?php echo $lang['system_size']; ?>
                                    </a>
                                </li>

                                <li class="submenu">
                                    <a style="color: #fff;" class="btnMenu" href="../budget">
                                ...
                                <li class="submenu">
                                    <a style="color: #fff;" class="btnMenu" href="../expected_saving">
                                        <!--<i class="mdi mdi-content-save-all"></i>-->
                                         <img style="height: 40px;margin-left: auto;margin-right: auto;margin-top: -12px;" src="../../assets/img/icon/3.png">
                                        <?php echo $lang['expected_saving']; ?>
                                    </a>
                                </li>
                                <li class="submenu" >
                                    <a style="color: #fff;" class="btnMenu" href="../recommended">
                                        <!--<i class="mdi mdi-content-save-all"></i>-->
                                         <img style="height: 40px;margin-left: auto;margin-right: auto;margin-top: -12px;" src="../../assets/img/icon/4.png">
                                        <?php echo $lang['recommended2']; ?>
                                    </a>
                                </li>
